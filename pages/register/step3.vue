            ...
            form#register-advanced-info.form-style
                .form-wrapper
                    ...
                    .form-style__item
                        ...
                        select(v-model="country" @change="verification")#country.form-style__item__select
                    ...
                    .form-style__item
                        ...
                        select(v-model="profession" @change="verification")#profession.form-style__item__select
                    ...
                    .form-style__item
                        ...
                        .form-style__item__subitem
                            select(v-model="maPostalCode" @change="verification")#ma-postal-code.form-style__item__select
                        ...
                        .form-style__item__wrapper
                            .form-style__item__subitem
                                select(v-model="maCounty" @change="verification")#ma-county.form-style__item__select
                                    option(value="" selected disabled) 縣/市
                                    option(v-for="item in maCountyOption" :value="item.value") {{item.title}}
                            .form-style__item__subitem
                                select(v-model="maRegion" @change="verification")#ma-region.form-style__item__select
                    ...
                    .form-style__item
                        ...
                        .ra-block(v-if="raType === 'other'")
                            .form-style__item__subitem
                                select(v-model="raPostalCode" @change="verification")#ra-postal-code.form-style__item__select
                                    option(value="" selected disabled) 郵遞區號
                                    option(v-for="item in raPostalCodeOption" :value="item.value") {{item.title}}
                            .form-style__item__wrapper
                                .form-style__item__subitem
                                    select(v-model="raCounty" @change="verification")#ra-county.form-style__item__select
                                        option(value="" selected disabled) 縣/市
                                        option(v-for="item in raCountyOption" :value="item.value") {{item.title}}
                                .form-style__item__subitem
                                    select(v-model="raRegion" @change="verification")#ra-region.form-style__item__select
                                        option(value="" selected disabled) 鄉/鎮/區
